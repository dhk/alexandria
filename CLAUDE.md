...
- **Mac** — the owner's laptop. **Global convention: every repo checkout
  ...
  everywhere. Alexandria's own repo is `~/Documents/dev/alexandria`.
...
- **Nothing is in flight without a bead.** Branches embed the bead id (`alexandria-a3f2-slug`);
  PR bodies carry a `bd: alexandria-a3f2` trailer.
